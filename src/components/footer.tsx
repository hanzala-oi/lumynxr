...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black text-white py-12 pt-[89px] xl:pt-32   ">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Bottom Section */}
        <div className="xl:border-t-[0.5px] border-[#868686] pt-4 xl:pt-8 flex items-center justify-center">

          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            {/* Copyright and Legal Links */}
            <div className="flex  md:flex-row items-center space-y-2 md:space-y-0 md:space-x-8 text-[#F2F2F2] text-[6px] xl:text-[16px] xl:tracking-[-0.198px]  font-[100] xl:font-[300]">
              <span className="xl:border-r-[0.5px]  pr-[73px] border-[#868686]">
                © 2024 One Immersive. All rights reserved.
              </span>
              <div className="flex space-x-6">
                <Link
                  href="/privacy"
                  className="pl-3 hover:text-white transition-colors duration-200 xl:border-r-[0.5px]  pr-[52px] border-[#868686]"
                >
                  Privacy Policy
                </Link>
                <Link
