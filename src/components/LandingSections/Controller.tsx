...
function Controller() {
  ...
  return (
    <div
      ref={sectionRef}
      className="flex flex-col xl:flex-row items-center justify-center xl:h-screen bg-black h-[70vh] overflow-hidden gap-20 px-6 md:pl-[115px] 2xl:pl-[199px] "
    >
      {/* Text Content */}
      <div className=" flex flex-col w-full justify-center xl:h-full ">
      ...
      {/* Video */}
      <div className=" rounded-[20px] overflow-hidden pb-[100px]">
        <video
          ref={videoRef}
          muted
          playsInline
