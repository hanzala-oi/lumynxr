...
function Controller() {
  ...
  return (
    <div
      ref={sectionRef}
      className="flex flex-col xl:flex-row items-center justify-center xl:h-screen bg-black h-[70vh] overflow-hidden gap-20 px-6 md:px-20 "
    >
      {/* Text Content */}
      <div className=" flex flex-col w-full justify-center xl:h-full xl:pl-[55px]">
