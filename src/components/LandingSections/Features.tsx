...
const features: Feature[] = [
  {
    ...
    sources: {
      ...
      mp4: `${process.env.NEXT_PUBLIC_CDN_URL}/videos/Ventilation_v3.mp4`,
    },
  },
  {
  ...
  },
  {
    ...
    sources: {
      ...
      mp4: `${process.env.NEXT_PUBLIC_CDN_URL}/videos/Battery_v3.mp4`,
    },
  },
];
      ...
      <div className="xl:w-4/5 h-full flex flex-col xl:flex-row items-center justify-center gap-4 xl:gap-2 xl:max-h-[85vh] xl:max-w-[85vw] ">
        ...
        <div className="w-full xl:w-1/2 h-full flex flex-col  gap-4 xl:gap-2 ">
          ...
          >
            ...
            <div className="md:w-full  p-8  group h-full group overflow-hidden   flex justify-end">
              <video
                ref={(el) => {
