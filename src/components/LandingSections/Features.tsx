    ...
    <div className="xl:h-screen min-h-screen w-screen flex flex-col xl:flex-row items-center justify-center xl:py-8 xl:px-10 2xl:px-20 2xl:py-20 py-8 px-4 md:px-6 ">
      <div className="xl:w-4/5 h-full flex flex-col xl:flex-row items-center justify-center gap-4 xl:gap-2 xl:max-h-[85vh] xl:max-w-[85vw] ">
        ...
        <div onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave} className="group w-full xl:w-1/2 h-full  gap-2 flex flex-row xl:flex-col  rounded-xl b-2 ">
          ...
          <div onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave} className="hidden xl:hidden md:flex   flex-col w-full  h-full bg-[#1a1919] rounded-xl group">
        ...
        <div className="w-full xl:w-1/2 h-full flex flex-col  gap-4 xl:gap-2 ">
          ...
          <div onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave} className="w-full xl:h-3/5 h-full bg-[#1a1919] rounded-xl group md:hidden xl:block">
          ...
          <div onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave} className="group w-full  xl:h-2/5 h-full bg-[#1a1919] rounded-xl flex flex-col md:flex-row  md:items-center overflow-hidden">
